...
public class Ids2 implements org.apache.thrift.TBase<Ids2, Ids2._Fields>, java.io.Serializable, Cloneable, Comparable<Ids2> {
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ANOTHER_MICRO_ID((short)1, "another_micro_id"),
    ANOTHER_MINI_ID((short)2, "another_mini_id"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 2: // ANOTHER_MINI_ID
          return ANOTHER_MINI_ID;
        case 3: // ANOTHER_ID
          return ANOTHER_ID;
        case 4: // ANOTHER_BIG_ID
  ...
  public Ids2 setAnotherMicroId(byte another_micro_id) {
    this.another_micro_id = another_micro_id;
    setAnotherMicroIdIsSet(true);
    return this;
  }
  ...
  public Ids2 setAnotherMiniId(short another_mini_id) {
    this.another_mini_id = another_mini_id;
    setAnotherMiniIdIsSet(true);
    return this;
  }
  ...
  public Ids2 setAnotherId(int another_id) {
    this.another_id = another_id;
    setAnotherIdIsSet(true);
    return this;
  }
  ...
  public Ids2 setAnotherBigId(long another_big_id) {
    this.another_big_id = another_big_id;
    setAnotherBigIdIsSet(true);
    return this;
  }
  ...
  @Override
  public int compareTo(Ids2 other) {
